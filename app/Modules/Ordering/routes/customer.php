 ...
 * UC-02: halaman sambutan sesudah pindai QR meja. Status pesanan pasca-checkout dikenali
 * lewat cookie pelacakan opaque (order_tracking), bukan ID pesanan di URL.
 */
