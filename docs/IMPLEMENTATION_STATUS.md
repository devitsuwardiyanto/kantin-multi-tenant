...
| 7 | **IN PROGRESS** (rantai v2) | `feat/pertemuan-07-catalog-v2` | `rebuild/modular-v2` | — | — | — | — | Menu manager Livewire (booted re-verify TenantContext) + public catalog Livewire (bypass terkontrol, eager load anti-N+1, search/filter URL-bound) sebagai komponen `catalog::` milik modul Catalog; MenuStockService atomik+audit; 93 test. Foto ditunda (DOC-07-001). |
| 8 | BELUM | — | — | — | — | — | — | |
| 9 | BELUM | — | — | — | — | — | — | |
| 10 | BELUM | — | — | — | — | — | — | |
| 11 | BELUM | — | — | — | — | — | — | |
