...
| 6 | **LULUS** | `feat/pertemuan-06-qr-session` (dihapus) | `pertemuan-05` | [#10](https://github.com/devitsuwardiyanto/kantin-multi-tenant/pull/10) | `5e12aa9` | `pertemuan-06` | [release](https://github.com/devitsuwardiyanto/kantin-multi-tenant/releases/tag/pertemuan-06) | OpaqueToken; QR issue/rotate; resolve→sesi anonim + cookie HttpOnly/SameSite; rate limiter; 404 anti-enumeration; 77 test. |
| 7 | **IN PROGRESS** (gate hijau, menunggu merge) | `feat/pertemuan-07-catalog` | `pertemuan-06` | — | — | — | — | Menu manager Livewire (booted re-verify TenantContext); MenuStockService atomik+audit; public catalog Livewire (bypass terkontrol, eager load anti-N+1, search/filter URL-bound); 84 test. Foto ditunda (DOC-07-001). |
| 8 | BELUM | — | — | — | — | — | — | |
| 9 | BELUM | — | — | — | — | — | — | |
| 10 | BELUM | — | — | — | — | — | — | |
| 11 | BELUM | — | — | — | — | — | — | |
