...
| 14 | Hardening, Pengujian E2E, Deployment, Demo | LULUS | `pertemuan-14`* | (PR ini) | #43 | 163 |
...
- **STATUS:** Pertemuan 2–14 dibangun ulang dan LULUS di `rebuild/modular-v2` (rantai lengkap). `main` dan tag lama belum diubah — menunggu persetujuan pemindahan tag + `main`.
...
- **REVISI MODUL:** DOC-00-001 (tema Cyan Light) · DOC-01-007 · DOC-02-004 · DOC-03-005 · DOC-04-005 · DOC-05-007/008 · DOC-06-006/007 · DOC-07-006/007 (DOC-07-001 foto menu selesai tanpa dependency baru) · DOC-08-006/007 · DOC-09-006/007 · DOC-10-006/007 · DOC-11-007/008 · DOC-12-006/007 · DOC-13-006/007 · DOC-00-002 (contoh folder ServBay).
- **KETERBATASAN:** gateway WhatsApp masih sandbox (`FakeWhatsAppGateway` menulis ke log; provider nyata belum dipilih) dan Web Push belum diimplementasikan — SRS mengizinkan “Web Push dan/atau WhatsApp”; pengembalian dana pesanan yang dibatalkan dapur baru ditandai (`refund_status = pending`, tampil “pengembalian dana menunggu” di rekonsiliasi) — pemrosesannya tidak termasuk 23 use case SRS dan belum diimplementasikan; pembayaran “perlu ditinjau” tampil di rekonsiliasi tenant, belum ada layar tindak lanjut khusus untuk pengelola; render DOCX penuh per halaman `TIDAK DIUJI` (tanpa LibreOffice/Word).
- **BERIKUTNYA:** Pertemuan 14 — uji penerimaan ke-23 use case + RTM akhir, hardening (SecurityHeaders, limiter webhook, uji E2E), lalu pemindahan tag `pertemuan-05…14` dan `main`.
