...
| 7 | **IN PROGRESS** (rantai v2) | `feat/pertemuan-07-catalog-v2` | `rebuild/modular-v2` | — | — | — | — | Menu manager Livewire (booted re-verify TenantContext) + public catalog Livewire (bypass terkontrol, eager load anti-N+1, search/filter URL-bound) sebagai komponen `catalog::` milik modul Catalog; MenuStockService atomik+audit; 93 test. Foto ditunda (DOC-07-001). **Rantai v3:** UC-13 Kelola Menu & Stok (ubah/hapus lunak, deskripsi, foto WebP via GD, cari/saring kategori) + UC-14 Tandai Habis (sakelar satu klik, audit) + UC-01 Telusuri (per tenant, menu habis nonaktif, tenant tutup + jam buka, chip kategori, poll 5 dtk) + UC-11 Estimasi Waktu Tunggu (antrean ÷ kapasitas paralel); 124 test. |
| 8 | BELUM | — | — | — | — | — | — | |
| 9 | BELUM | — | — | — | — | — | — | |
| 10 | BELUM | — | — | — | — | — | — | |
| 11 | BELUM | — | — | — | — | — | — | |
