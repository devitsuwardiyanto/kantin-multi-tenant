...
- **STATUS:** mulai Pertemuan 5 setiap pertemuan menuntaskan minimal satu use case SRS v2 (23 UC, tuntas pada Pertemuan 14). Pertemuan 5–8 LULUS (12 dari 23 UC); Pertemuan 9–14 menyusul.
- **GIT:** branch integrasi `rebuild/usecase-v3`; rentang v2 Pertemuan 5–14 diarsipkan sebagai tag `arsip-v2/pertemuan-05…14`; satu PR per pertemuan (rebase merge, CI hijau): P5 #44 (+ #45 langkah Windows, #46 tema kode, #47 aturan, #48–#51 konversi Modul 1–4), P6 #52, P7 #53, P8 PR ini. `main` dan tag `pertemuan-NN` dipindah setelah rantai hijau.
...
- **VERIFIKASI:** per pertemuan Pint + PHPStan 0 + suite penuh di MariaDB nyata dengan cache/sesi array **dan** Redis + CI; uji browser (puppeteer + Chrome) pada server demo; langkah manual Windows dijalankan ulang di worktree bersih (cmd diterjemahkan) — hasil Tahap 7 identik dengan kode v2 dan hasil Tahap 8 identik dengan kode akhir (P7: 117 → 124 test; P8: 140 → 155 test).
...
- **REVISI MODUL:** DOC-00-001 (tema Cyan Light) · DOC-01-007 · DOC-02-004 · DOC-03-005 · DOC-04-005 · DOC-05-007/008 · DOC-06-006/007 · DOC-07-006/007 (DOC-07-001 foto menu selesai tanpa dependency baru) · DOC-08-006/007.
- **KETERBATASAN:** catatan khusus item baru tersimpan di keranjang; kolom catatan pada `order_items` ditambahkan saat checkout (Pertemuan 9); render DOCX penuh per halaman `TIDAK DIUJI` (tanpa LibreOffice/Word).
- **BERIKUTNYA:** Pertemuan 9 — UC-05 Checkout Pesanan + UC-06 Jadwalkan Pre-Order.
