...
class FinanceFlowTest extends TestCase
{
    ...
    public function test_finance_and_withdrawal_pages_render_module_components(): void
    {
        [$canteen, $tenant, , $member] = $this->scenario();

        $this->actingAs($member)
            ->get(route('tenant.finance', ['tenant' => $tenant->slug]))
            ->assertOk()
            ->assertSeeLivewire('reporting::finance-panel');
