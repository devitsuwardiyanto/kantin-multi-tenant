...
| 8 | **IN PROGRESS** (rantai v2) | `feat/pertemuan-08-cart-v2` | `rebuild/modular-v2` | — | — | — | — | Keranjang Redis per sesi (SETEX/DEL satu key, TTL sesi) + revalidasi harga/stok dari DB; komponen `ordering::cart` + event `cart-add` dari katalog; 109 test. **Rantai v3:** UC-03 Kelola Keranjang (kelompok per tenant, pajak & biaya layanan per tenant, “Menu telah habis”, checkout nonaktif saat kosong) + UC-04 Kustomisasi Item (`ordering::item-customizer`: min/maks, opsi habis nonaktif, catatan ≤ 200 tersaring) + `catalog::modifier-manager`; 155 test. |
| 9 | BELUM | — | — | — | — | — | — | |
| 10 | BELUM | — | — | — | — | — | — | |
| 11 | BELUM | — | — | — | — | — | — | |
| 12 | BELUM | — | — | — | — | — | — | |
