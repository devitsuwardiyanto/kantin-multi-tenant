...
|---|---:|---|
| `php artisan test` | 0 | **65 passed** (187 assertions) — 10 uji isolasi baru; rantai vertical slice |
| `composer test` (pint+phpstan+test) | 0 | pint passed · phpstan 0 · 65 passed |
| `npm run build` | 0 | OK |
