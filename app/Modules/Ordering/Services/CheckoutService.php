...
final class CheckoutService
{
    ...
    /**
     * Skema komisi efektif untuk tenant saat ini (effective-dated, interval setengah-terbuka
     * [valid_from, valid_to) lewat scope CommissionScheme::effectiveAt). Tidak ada skema aktif →
