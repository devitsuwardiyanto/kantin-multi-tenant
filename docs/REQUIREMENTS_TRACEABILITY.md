...
| UC-06 Jadwalkan Pre-Order | FR-CUS-07 | 9 | `app/Modules/Ordering/Services/PreOrderScheduler.php`, `Console/ReleaseScheduledOrders.php` (`ordering:release-scheduled` tiap menit), komponen `ordering::pre-order-settings`; pengingat WhatsApp menyusul UC-12 (P12) | `tests/Feature/PreOrderUseCaseTest.php` + uji browser | PASS |
