 ...
 * komponen Livewire <livewire:catalog::menu-manager> (Modul 7); halaman modifier-manager
 * merender <livewire:catalog::modifier-manager> (Modul 8, konfigurasi UC-04).
 */
PortalRoutes::tenant(function (): void {
    ...
    Route::get('/modifiers', fn (Tenant $tenant) => view('catalog::tenant.modifier-manager', ['tenant' => $tenant]))
