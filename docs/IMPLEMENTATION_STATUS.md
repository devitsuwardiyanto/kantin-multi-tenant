...
| 6 | **IN PROGRESS** (rantai v2) | `feat/pertemuan-06-qr-v2` | `rebuild/modular-v2` | — | — | — | — | OpaqueToken (CSPRNG+SHA256); CRUD meja + QR issue/rotate (lock+revoke) di modul Admin; resolve QR→sesi anonim ULID + cookie HttpOnly/SameSite di modul Ordering (route publik + rate limiter milik modul); 404 generik anti-enumeration; 85 test. QR raster ditunda (DOC-06-001). **Rantai v3:** UC-22 Kelola Meja & QR (QR SVG siap cetak via bacon, nonaktif/aktif meja) + UC-02 Pindai QR (sambutan meja, tenant buka/tutup, pesan QR tidak valid, tolak di luar jam operasional); 109 test. |
| 7 | BELUM | — | — | — | — | — | — | |
| 8 | BELUM | — | — | — | — | — | — | |
| 9 | BELUM | — | — | — | — | — | — | |
| 10 | BELUM | — | — | — | — | — | — | |
